...
public class InputOutput {
	...
	public static Covid_Test addCovid_Test() {
		...
		try {
			...
			while (!public_private.equalsIgnoreCase("public") && !public_private.equalsIgnoreCase("private")) {
				System.out.println("Incorrectly entered data");
				System.out.println("Public or private test:");
				public_private = get_String();
			}
			System.out.println("Type of test(pcr,rapid test or antibody test)");
			String type_test = get_String();
			while (!type_test.equalsIgnoreCase("pcr") && !type_test.equalsIgnoreCase("rapid test")
					&& !type_test.equalsIgnoreCase("antibody test")) {
				System.out.println("Incorrectly entered data");
				System.out.println("Type of test(pcr,rapid test or antibody test)");
				type_test = get_String();
			}
